//
// File generated by rootcint at Fri Jul 11 13:37:49 2014
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::FrameStruct*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("FrameStruct", ::FrameStruct::Class_Version(), "./include/allpix_dm.h", 85,
...
namespace ROOT {
   void WriteToNtupleRD53_ShowMembers(void *obj, TMemberInspector &R__insp);
   static void delete_WriteToNtupleRD53(void *p);
   static void deleteArray_WriteToNtupleRD53(void *p);
   static void destruct_WriteToNtupleRD53(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::WriteToNtupleRD53*)
   {
      ::WriteToNtupleRD53 *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::WriteToNtupleRD53 >(0);
      static ::ROOT::TGenericClassInfo 
         instance("WriteToNtupleRD53", ::WriteToNtupleRD53::Class_Version(), "./include/AllPix_Frames_WriteToEntuple_RD53.h", 33,
                  typeid(::WriteToNtupleRD53), DefineBehavior(ptr, ptr),
                  &::WriteToNtupleRD53::Dictionary, isa_proxy, 4,
                  sizeof(::WriteToNtupleRD53) );
      instance.SetDelete(&delete_WriteToNtupleRD53);
      instance.SetDeleteArray(&deleteArray_WriteToNtupleRD53);
      instance.SetDestructor(&destruct_WriteToNtupleRD53);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::WriteToNtupleRD53*)
   {
      return GenerateInitInstanceLocal((::WriteToNtupleRD53*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::WriteToNtupleRD53*)0x0); R__UseDummy(_R__UNIQUE_(Init));
} // end of namespace ROOT
...
//______________________________________________________________________________
TClass *WriteToNtupleRD53::fgIsA = 0;  // static to hold class pointer

//______________________________________________________________________________
const char *WriteToNtupleRD53::Class_Name()
{
   return "WriteToNtupleRD53";
}

//______________________________________________________________________________
const char *WriteToNtupleRD53::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::WriteToNtupleRD53*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int WriteToNtupleRD53::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::WriteToNtupleRD53*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void WriteToNtupleRD53::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::WriteToNtupleRD53*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *WriteToNtupleRD53::Class()
{
   if (!fgIsA) fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::WriteToNtupleRD53*)0x0)->GetClass();
   return fgIsA;
}
...
void FrameContainer::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "RD53_E_MC", (void*)&RD53_E_MC);
      R__insp.InspectMember("map<std::pair<Int_t,Int_t>,Double_t>", (void*)&RD53_E_MC, "RD53_E_MC.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "RD53_E", (void*)&RD53_E);
      R__insp.InspectMember("map<std::pair<Int_t,Int_t>,Double_t>", (void*)&RD53_E, "RD53_E.", false);
...
//______________________________________________________________________________
void WriteToNtupleRD53::Streamer(TBuffer &R__b)
{
   // Stream an object of class WriteToNtupleRD53.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(WriteToNtupleRD53::Class(),this);
   } else {
      R__b.WriteClassBuffer(WriteToNtupleRD53::Class(),this);
   }
}

//______________________________________________________________________________
void WriteToNtupleRD53::ShowMembers(TMemberInspector &R__insp)
{
      // Inspect the data members of an object of class WriteToNtupleRD53.
      TClass *R__cl = ::WriteToNtupleRD53::IsA();
      if (R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*m_frame", &m_frame);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*h1", &h1);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "*nt", &nt);
      ...
      R__insp.InspectMember(m_ntupleFileName, "m_ntupleFileName.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "m_detID", &m_detID);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "posX", (void*)&posX);
      R__insp.InspectMember("vector<Int_t>", (void*)&posX, "posX.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "posY", (void*)&posY);
      R__insp.InspectMember("vector<Int_t>", (void*)&posY, "posY.", false);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "MC_posX", (void*)&MC_posX);
      R__insp.InspectMember("vector<int>", (void*)&MC_posX, "MC_posX.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "MC_posY", (void*)&MC_posY);
      R__insp.InspectMember("vector<int>", (void*)&MC_posY, "MC_posY.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "MC_energy", (void*)&MC_energy);
      R__insp.InspectMember("vector<double>", (void*)&MC_energy, "MC_energy.", false);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "MC_nHits", &MC_nHits);
}

namespace ROOT {
   // Wrapper around operator delete
   static void delete_WriteToNtupleRD53(void *p) {
      delete ((::WriteToNtupleRD53*)p);
   }
   static void deleteArray_WriteToNtupleRD53(void *p) {
      delete [] ((::WriteToNtupleRD53*)p);
   }
   static void destruct_WriteToNtupleRD53(void *p) {
      typedef ::WriteToNtupleRD53 current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::WriteToNtupleRD53
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<pair<int,int>,double>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<pair<int,int>,double>", -2, "/afs/cern.ch/sw/lcg/app/releases/ROOT/5.34.00/x86_64-slc5-gcc43-opt/root/cint/cint/lib/prec_stl/map", 63,
                  typeid(map<pair<int,int>,double>), DefineBehavior(ptr, ptr),
   ...
   // Dictionary for non-ClassDef classes
   static void maplEpairlEintcOintgRcOdoublegR_Dictionary() {
      ::ROOT::GenerateInitInstanceLocal((const map<pair<int,int>,double>*)0x0)->GetClass();
   }
...
{
   WriteToNtupleRD53* p = NULL;
   char* gvp = (char*) G__getgvp();
   switch (libp->paran) {
   case 5:
     //m: 5
     if ((gvp == (char*)G__PVOID) || (gvp == 0)) {
       p = new WriteToNtupleRD53(
*((TString*) G__int(libp->para[0])), *((TString*) G__int(libp->para[1]))
, *((TString*) G__int(libp->para[2])), (Int_t) G__int(libp->para[3])
, *((TString*) G__int(libp->para[4])));
     } else {
       p = new((void*) gvp) WriteToNtupleRD53(
*((TString*) G__int(libp->para[0])), *((TString*) G__int(libp->para[1]))
, *((TString*) G__int(libp->para[2])), (Int_t) G__int(libp->para[3])
, *((TString*) G__int(libp->para[4])));
     }
...
, *((TString*) G__int(libp->para[2])), (Int_t) G__int(libp->para[3]));
   ...
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__SelDictLN_WriteToNtupleRD53));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_668_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((WriteToNtupleRD53*) G__getstructoffset())->fillVarsRD53((FramesHandler*) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((WriteToNtupleRD53*) G__getstructoffset())->closeNtuple();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__SelDict_668_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         TString* pobj;
         TString xobj = ((WriteToNtupleRD53*) G__getstructoffset())->GetNtupleFileName();
         pobj = new TString(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
static int G__SelDict_668_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 6:
      G__letint(result7, 85, (long) WriteToNtupleRD53::GetInstanceRD53(*((TString*) G__int(libp->para[0])), *((TString*) G__int(libp->para[1]))
, *((TString*) G__int(libp->para[2])), (Int_t) G__int(libp->para[3])
, (Int_t) G__int(libp->para[4]), *((TString*) G__int(libp->para[5]))));
      break;
   case 5:
...
{
      G__letint(result7, 85, (long) ((const WriteToNtupleRD53*) G__getstructoffset())->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_668_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((WriteToNtupleRD53*) G__getstructoffset())->ShowMembers(*(TMemberInspector*) libp->para[0].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((WriteToNtupleRD53*) G__getstructoffset())->Streamer(*(TBuffer*) libp->para[0].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((WriteToNtupleRD53*) G__getstructoffset())->StreamerNVirtual(*(TBuffer*) libp->para[0].ref);
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...

{
   WriteToNtupleRD53* p;
   void* tmp = (void*) G__int(libp->para[0]);
   p = new WriteToNtupleRD53(*(WriteToNtupleRD53*) tmp);
   result7->obj.i = (long) p;
   result7->ref = (long) p;
   G__set_tagnum(result7,G__get_linked_tagnum(&G__SelDictLN_WriteToNtupleRD53));
   return(1 || funcname || hash || result7 || libp) ;
...
// automatic destructor
typedef WriteToNtupleRD53 G__TWriteToNtupleRD53;
static int G__SelDict_668_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   ...
   if (n) {
     if (gvp == (char*)G__PVOID) {
       delete[] (WriteToNtupleRD53*) soff;
     } else {
       G__setgvp((long) G__PVOID);
       for (int i = n - 1; i >= 0; --i) {
         ((WriteToNtupleRD53*) (soff+(sizeof(WriteToNtupleRD53)*i)))->~G__TWriteToNtupleRD53();
       }
       G__setgvp((long)gvp);
     }
   } else {
     if (gvp == (char*)G__PVOID) {
       ...
       G__setgvp((long) G__PVOID);
       ((WriteToNtupleRD53*) (soff))->~G__TWriteToNtupleRD53();
       G__setgvp((long)gvp);
     }
   }
   G__setnull(result7);
...
{
   WriteToNtupleRD53* dest = (WriteToNtupleRD53*) G__getstructoffset();
   *dest = *(WriteToNtupleRD53*) libp->para[0].ref;
   const WriteToNtupleRD53& obj = *dest;
   result7->ref = (long) (&obj);
   result7->obj.i = (long) (&obj);
   return(1 || funcname || hash || result7 || libp) ;
}
...
/* FrameContainer */
static int G__SelDict_669_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_669_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_669_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((FrameContainer*) G__getstructoffset())->FillOneElement((Int_t) G__int(libp->para[0]), (Int_t) G__int(libp->para[1])
, (Int_t) G__int(libp->para[2]), (Int_t) G__int(libp->para[3]));
      G__setnull(result7);
...
static int G__SelDict_669_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((FrameContainer*) G__getstructoffset())->FillOneElementRD53_MC((Int_t) G__int(libp->para[0]), (Int_t) G__int(libp->para[1])
, (Double_t) G__double(libp->para[2]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_669_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      ((FrameContainer*) G__getstructoffset())->FillOneElementRD53((Int_t) G__int(libp->para[0]), (Int_t) G__int(libp->para[1])
, (Double_t) G__double(libp->para[2]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_669_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_669_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_669_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_669_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_669_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((FrameContainer*) G__getstructoffset())->GetEntriesPad());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_669_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((FrameContainer*) G__getstructoffset())->GetHitsInPad());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_669_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((FrameContainer*) G__getstructoffset())->GetChargeInPad());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_669_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         map<std::pair<Int_t,Int_t>,Double_t>* pobj;
         map<std::pair<Int_t,Int_t>,Double_t> xobj = ((FrameContainer*) G__getstructoffset())->return_RD53_E_MC();
         pobj = new map<std::pair<Int_t,Int_t>,Double_t>(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
      }
...
static int G__SelDict_669_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         map<std::pair<Int_t,Int_t>,Double_t>* pobj;
         map<std::pair<Int_t,Int_t>,Double_t> xobj = ((FrameContainer*) G__getstructoffset())->return_RD53_E();
         pobj = new map<std::pair<Int_t,Int_t>,Double_t>(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
static int G__SelDict_669_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) FrameContainer::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_669_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) FrameContainer::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_669_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) FrameContainer::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_669_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_669_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const FrameContainer*) G__getstructoffset())->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_669_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_669_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_669_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_669_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) FrameContainer::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_669_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) FrameContainer::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_669_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) FrameContainer::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_669_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
// automatic copy constructor
static int G__SelDict_669_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__SelDict_669_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G__SelDict_669_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_774_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_774_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_774_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_774_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_774_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_774_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_774_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) AllPixDigitAnimation::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_774_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) AllPixDigitAnimation::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_774_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) AllPixDigitAnimation::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_774_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_774_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__SelDict_774_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) AllPixDigitAnimation::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_774_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) AllPixDigitAnimation::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_774_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) AllPixDigitAnimation::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__SelDict_774_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
// automatic copy constructor
static int G__SelDict_774_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__SelDict_774_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G__SelDict_774_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
extern "C" void G__cpp_setup_typetableSelDict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("pair<Int_t,Int_t>",117,G__get_linked_tagnum(&G__SelDictLN_pairlEintcOintgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("map<std::pair<Int_t,Int_t>,Double_t>",117,G__get_linked_tagnum(&G__SelDictLN_maplEpairlEintcOintgRcOdoublecOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOdoublegRsPgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("map<pair<Int_t,Int_t>,Double_t>",117,G__get_linked_tagnum(&G__SelDictLN_maplEpairlEintcOintgRcOdoublecOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOdoublegRsPgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("map<pair<int,int>,double>",117,G__get_linked_tagnum(&G__SelDictLN_maplEpairlEintcOintgRcOdoublecOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOdoublegRsPgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("map<pair<int,int>,double,less<pair<int,int> > >",117,G__get_linked_tagnum(&G__SelDictLN_maplEpairlEintcOintgRcOdoublecOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOdoublegRsPgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
...
static void G__setup_memvarWriteToNtuple(void) {
   ...
   /* WriteToNtupleRD53 */
static void G__setup_memvarWriteToNtupleRD53(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__SelDictLN_WriteToNtupleRD53));
   { WriteToNtupleRD53 *p; p=(WriteToNtupleRD53*)0x1000; if (p) { }
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__SelDictLN_FrameStruct),-1,-1,4,"m_frame=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__SelDictLN_TH2),-1,-1,4,"h1=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__SelDictLN_TFile),-1,-1,4,"nt=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__SelDictLN_TTree),-1,-1,4,"t2=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__SelDictLN_TString),-1,-1,4,"m_ntupleFileName=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,G__defined_typename("Int_t"),-1,4,"m_detID=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__SelDictLN_vectorlEintcOallocatorlEintgRsPgR),G__defined_typename("vector<Int_t>"),-1,4,"posX=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__SelDictLN_vectorlEintcOallocatorlEintgRsPgR),G__defined_typename("vector<Int_t>"),-1,4,"posY=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__SelDictLN_vectorlEdoublecOallocatorlEdoublegRsPgR),G__defined_typename("vector<Double_t>"),-1,4,"energy=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,G__defined_typename("Int_t"),-1,4,"nHits=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__SelDictLN_vectorlEintcOallocatorlEintgRsPgR),G__defined_typename("vector<int>"),-1,4,"MC_posX=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__SelDictLN_vectorlEintcOallocatorlEintgRsPgR),G__defined_typename("vector<int>"),-1,4,"MC_posY=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__SelDictLN_vectorlEdoublecOallocatorlEdoublegRsPgR),G__defined_typename("vector<double>"),-1,4,"MC_energy=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,G__defined_typename("Int_t"),-1,4,"MC_nHits=",0,(char*)NULL);
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__SelDictLN_TClass),-1,-2,4,"fgIsA=",0,(char*)NULL);
   G__memvar_setup((void*)0,108,0,0,-1,-1,-1,4,"G__virtualinfo=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
...
static void G__setup_memvarFrameContainer(void) {
   ...
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__SelDictLN_maplEpairlEintcOintgRcOdoublecOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOdoublegRsPgRsPgR),G__defined_typename("map<std::pair<Int_t,Int_t>,Double_t>"),-1,4,"RD53_E_MC=",0,"True Monte Carlo energy");
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__SelDictLN_maplEpairlEintcOintgRcOdoublecOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOdoublegRsPgRsPgR),G__defined_typename("map<std::pair<Int_t,Int_t>,Double_t>"),-1,4,"RD53_E=",0,"Energy taking into account the ");
...
static void G__setup_memfuncWriteToNtupleRD53(void) {
   /* WriteToNtupleRD53 */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__SelDictLN_WriteToNtupleRD53));
   G__memfunc_setup("WriteToNtupleRD53",1604,G__SelDict_668_0_1, 105, G__get_linked_tagnum(&G__SelDictLN_WriteToNtupleRD53), -1, 0, 5, 1, 1, 0, 
"u 'TString' - 0 - - u 'TString' - 0 - - "
"u 'TString' - 0 - - i - 'Int_t' 0 - - "
"u 'TString' - 0 '\"RECREATE\"' om", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("fillVarsRD53",1089,G__SelDict_668_0_2, 121, -1, -1, 0, 1, 1, 1, 0, "U 'FramesHandler' - 0 - -", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("closeNtuple",1166,G__SelDict_668_0_3, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetNtupleFileName",1689,G__SelDict_668_0_4, 117, G__get_linked_tagnum(&G__SelDictLN_TString), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetInstanceRD53",1363,G__SelDict_668_0_5, 85, G__get_linked_tagnum(&G__SelDictLN_WriteToNtupleRD53), -1, 0, 6, 3, 1, 0, 
"u 'TString' - 0 - - u 'TString' - 0 - - "
"u 'TString' - 0 - - i - 'Int_t' 0 - - "
"i - 'Int_t' 0 - - u 'TString' - 0 '\"RECREATE\"' openmode", (char*)NULL, (void*) G__func2void( (WriteToNtupleRD53* (*)(TString, TString, TString, Int_t, Int_t, TString))(&WriteToNtupleRD53::GetInstanceRD53) ), 0);
   G__memfunc_setup("GetTree",688,G__SelDict_668_0_6, 85, G__get_linked_tagnum(&G__SelDictLN_TTree), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetDetectorId",1287,G__SelDict_668_0_7, 105, -1, G__defined_typename("Int_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__SelDict_668_0_8, 85, G__get_linked_tagnum(&G__SelDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&WriteToNtupleRD53::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__SelDict_668_0_9, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&WriteToNtupleRD53::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__SelDict_668_0_10, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&WriteToNtupleRD53::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__SelDict_668_0_11, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&WriteToNtupleRD53::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,G__SelDict_668_0_12, 85, G__get_linked_tagnum(&G__SelDictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,G__SelDict_668_0_13, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,G__SelDict_668_0_14, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__SelDict_668_0_15, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__SelDict_668_0_16, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&WriteToNtupleRD53::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__SelDict_668_0_17, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&WriteToNtupleRD53::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__SelDict_668_0_18, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&WriteToNtupleRD53::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__SelDict_668_0_19, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&WriteToNtupleRD53::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("WriteToNtupleRD53", 1604, G__SelDict_668_0_20, (int) ('i'), G__get_linked_tagnum(&G__SelDictLN_WriteToNtupleRD53), -1, 0, 1, 1, 1, 0, "u 'WriteToNtupleRD53' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~WriteToNtupleRD53", 1730, G__SelDict_668_0_21, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__SelDict_668_0_22, (int) ('u'), G__get_linked_tagnum(&G__SelDictLN_WriteToNtupleRD53), -1, 1, 1, 1, 1, 0, "u 'WriteToNtupleRD53' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncFrameContainer(void) {
   ...
   G__memfunc_setup("FrameContainer",1422,G__SelDict_669_0_1, 105, G__get_linked_tagnum(&G__SelDictLN_FrameContainer), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("FillOneElement",1395,G__SelDict_669_0_2, 121, -1, -1, 0, 6, 1, 1, 0, 
"i - 'Int_t' 0 - - i - 'Int_t' 0 - - "
"i - 'Int_t' 0 - - i - 'Int_t' 0 - - "
"d - 'Double_t' 0 - - d - 'Double_t' 0 - -", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("FillOneElement",1395,G__SelDict_669_0_3, 121, -1, -1, 0, 4, 1, 1, 0, 
"i - 'Int_t' 0 - - i - 'Int_t' 0 - - "
"i - 'Int_t' 0 - - i - 'Int_t' 0 - -", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("FillOneElementRD53_MC",1888,G__SelDict_669_0_4, 121, -1, -1, 0, 3, 1, 1, 0, 
"i - 'Int_t' 0 - xi i - 'Int_t' 0 - yi "
"d - 'Double_t' 0 - truthE", "nalipour //MC", (void*) NULL, 0);
   G__memfunc_setup("FillOneElementRD53",1649,G__SelDict_669_0_5, 121, -1, -1, 0, 3, 1, 1, 0, 
"i - 'Int_t' 0 - xi i - 'Int_t' 0 - yi "
"d - 'Double_t' 0 - E", "nalipour //Considering charge sharing", (void*) NULL, 0);
   G__memfunc_setup("SetLVL1",587,G__SelDict_669_0_6, 121, -1, -1, 0, 4, 1, 1, 0, 
"i - 'Int_t' 0 - - i - 'Int_t' 0 - - "
"i - 'Int_t' 0 - - i - 'Int_t' 0 - -", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("ResetCountersPad",1643,G__SelDict_669_0_7, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("CleanUpMatrix",1309,G__SelDict_669_0_8, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetFrameAsMCData",1493,G__SelDict_669_0_9, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetEntriesPad",1295,G__SelDict_669_0_10, 105, -1, G__defined_typename("Int_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetHitsInPad",1156,G__SelDict_669_0_11, 105, -1, G__defined_typename("Int_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetChargeInPad",1334,G__SelDict_669_0_12, 105, -1, G__defined_typename("Int_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("return_RD53_E_MC",1424,G__SelDict_669_0_13, 117, G__get_linked_tagnum(&G__SelDictLN_maplEpairlEintcOintgRcOdoublecOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOdoublegRsPgRsPgR), G__defined_typename("map<std::pair<Int_t,Int_t>,Double_t>"), 0, 0, 1, 1, 0, "", "nalipour", (void*) NULL, 0);
   G__memfunc_setup("return_RD53_E",1185,G__SelDict_669_0_14, 117, G__get_linked_tagnum(&G__SelDictLN_maplEpairlEintcOintgRcOdoublecOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOdoublegRsPgRsPgR), G__defined_typename("map<std::pair<Int_t,Int_t>,Double_t>"), 0, 0, 1, 1, 0, "", "nalipour", (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__SelDict_669_0_15, 85, G__get_linked_tagnum(&G__SelDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&FrameContainer::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__SelDict_669_0_16, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&FrameContainer::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__SelDict_669_0_17, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&FrameContainer::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__SelDict_669_0_18, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&FrameContainer::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,G__SelDict_669_0_19, 85, G__get_linked_tagnum(&G__SelDictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,G__SelDict_669_0_20, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,G__SelDict_669_0_21, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__SelDict_669_0_22, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__SelDict_669_0_23, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&FrameContainer::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__SelDict_669_0_24, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&FrameContainer::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__SelDict_669_0_25, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&FrameContainer::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__SelDict_669_0_26, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&FrameContainer::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("FrameContainer", 1422, G__SelDict_669_0_27, (int) ('i'), G__get_linked_tagnum(&G__SelDictLN_FrameContainer), -1, 0, 1, 1, 1, 0, "u 'FrameContainer' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~FrameContainer", 1548, G__SelDict_669_0_28, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__SelDict_669_0_29, (int) ('u'), G__get_linked_tagnum(&G__SelDictLN_FrameContainer), -1, 1, 1, 1, 1, 0, "u 'FrameContainer' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncAllPixDigitAnimation(void) {
   ...
   G__memfunc_setup("AllPixDigitAnimation",2011,G__SelDict_774_0_1, 105, G__get_linked_tagnum(&G__SelDictLN_AllPixDigitAnimation), -1, 0, 7, 1, 1, 0, 
"i - - 0 - nx i - - 0 - ny "
"d - - 0 - lz d - - 0 - pitchx "
"d - - 0 - pitchy i - - 0 - nHits "
"i - - 0 - eventid", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddTrack",766,G__SelDict_774_0_2, 121, -1, -1, 0, 6, 1, 1, 0, 
...
"d - - 0 - sigma d - - 0 - energy", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("modulo",656,G__SelDict_774_0_3, 100, -1, -1, 0, 2, 1, 1, 0, 
"d - - 0 - a d - - 0 - b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("FirePixel",904,G__SelDict_774_0_4, 121, -1, -1, 0, 2, 1, 1, 0, 
"i - - 0 - i i - - 0 - j", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SubThresholdPixel",1753,G__SelDict_774_0_5, 121, -1, -1, 0, 2, 1, 1, 0, 
"i - - 0 - i i - - 0 - j", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetShift",810,G__SelDict_774_0_6, 121, -1, -1, 0, 2, 1, 1, 0, 
"d - - 0 - x d - - 0 - y", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__SelDict_774_0_7, 85, G__get_linked_tagnum(&G__SelDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&AllPixDigitAnimation::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__SelDict_774_0_8, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&AllPixDigitAnimation::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__SelDict_774_0_9, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&AllPixDigitAnimation::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__SelDict_774_0_10, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&AllPixDigitAnimation::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,(G__InterfaceMethod) NULL,85, G__get_linked_tagnum(&G__SelDictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__SelDict_774_0_14, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__SelDict_774_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&AllPixDigitAnimation::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__SelDict_774_0_16, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&AllPixDigitAnimation::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__SelDict_774_0_17, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&AllPixDigitAnimation::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__SelDict_774_0_18, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&AllPixDigitAnimation::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("AllPixDigitAnimation", 2011, G__SelDict_774_0_19, (int) ('i'), G__get_linked_tagnum(&G__SelDictLN_AllPixDigitAnimation), -1, 0, 1, 1, 1, 0, "u 'AllPixDigitAnimation' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~AllPixDigitAnimation", 2137, G__SelDict_774_0_20, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__SelDict_774_0_21, (int) ('u'), G__get_linked_tagnum(&G__SelDictLN_AllPixDigitAnimation), -1, 1, 1, 1, 1, 0, "u 'AllPixDigitAnimation' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
G__linked_taginfo G__SelDictLN_pairlEintcOintgR = { "pair<int,int>" , 115 , -1 };
...
G__linked_taginfo G__SelDictLN_WriteToNtupleRD53 = { "WriteToNtupleRD53" , 99 , -1 };
G__linked_taginfo G__SelDictLN_FrameContainer = { "FrameContainer" , 99 , -1 };
G__linked_taginfo G__SelDictLN_maplEpairlEintcOintgRcOdoublecOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOdoublegRsPgRsPgR = { "map<pair<int,int>,double,less<pair<int,int> >,allocator<pair<const pair<int,int>,double> > >" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableSelDict() {
  ...
  G__SelDictLN_pairlEintcOintgR.tagnum = -1 ;
  ...
  G__SelDictLN_WriteToNtupleRD53.tagnum = -1 ;
  G__SelDictLN_FrameContainer.tagnum = -1 ;
  G__SelDictLN_maplEpairlEintcOintgRcOdoublecOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOdoublegRsPgRsPgR.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableSelDict() {
   ...
   G__get_linked_tagnum_fwd(&G__SelDictLN_pairlEintcOintgR);
   ...
   G__tagtable_setup(G__get_linked_tagnum_fwd(&G__SelDictLN_WriteToNtupleRD53),sizeof(WriteToNtupleRD53),-1,295936,(char*)NULL,G__setup_memvarWriteToNtupleRD53,G__setup_memfuncWriteToNtupleRD53);
   ...
   G__get_linked_tagnum_fwd(&G__SelDictLN_maplEpairlEintcOintgRcOdoublecOlesslEpairlEintcOintgRsPgRcOallocatorlEpairlEconstsPpairlEintcOintgRcOdoublegRsPgRsPgR);
