...
//       //hit_energy=elec*CLHEP::RandGauss::shoot(hit_energy/elec, hit_energy/elec); //First noise //?????? What does it means???
//       // //------- noise 1 ------- //
...
//       G4cout << "*********before noise=" << pixelsContent[tempPixel]/keV << G4endl;
...
//       G4cout << "after noise=" << pixelsContent[tempPixel] << G4endl;
