...
__Digitizer::__Digitizer(G4String modName, G4String hitsColName, G4String digitColName) 
...
__Digitizer::~__Digitizer(){

}

void __Digitizer::Digitize(){

	// create the digits collection
	m_digitsCollection = new __DigitsCollection("__Digitizer", collectionName[0] );
