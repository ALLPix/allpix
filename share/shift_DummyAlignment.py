...
def doAlignmentDummy( outputFileName ):
    ...
    alignVals = [[0 for col in range(nValues)] for row in range(6)]
    alignVals[1][0]=0.1 #EUD1, xOff
    alignVals[1][1]=-0.3 #EUD1, xOff
    
    # alignVals[2][1]=1 #EUD2, yOff  
      
    # alignVals[3][0]=0.7 #EUD3, xOff   
    # alignVals[3][1]=0.2 #EUD3, yOff

    # alignVals[4][0]=0.5 #EUD4, xOff   
    # alignVals[4][1]=0.5 #EUD4, yOff

    # alignVals[5][0]=1.5 #EUD5, xOff   
    # alignVals[5][1]=0.0 #EUD5, yOff
    ...
    for sensorID in xrange( 4, 10 ):
        ...
        for i in xrange( nValues ):
            ...
            alignObj.setDoubleVal( i, alignVals[sensorID-4][i] )    
 
        alignObj.setIntVal( 0, sensorID-4 ) #Nilou
