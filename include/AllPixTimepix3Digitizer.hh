...
#ifndef AllPixTimepix3Digitizer_h
#define AllPixTimepix3Digitizer_h 1
...
/**
 *  Digitizer AllPixTimepix3 implementation
 */
class AllPixTimepix3Digitizer : public  AllPixDigitizerInterface {

public:
  AllPixTimepix3Digitizer(G4String, G4String, G4String);
  virtual ~AllPixTimepix3Digitizer();
...
private:
  ...
  AllPixTimepix3DigitsCollection * m_digitsCollection;
