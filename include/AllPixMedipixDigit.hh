...
#ifndef AllPixMedipixDigit_h
#define AllPixMedipixDigit_h 1
...
/**
 *  Digit AllPixMedipix class.
 */
class AllPixMedipixDigit : public AllPixDigitInterface {

public:
  AllPixMedipixDigit();
  ~AllPixMedipixDigit();

  AllPixMedipixDigit(const AllPixMedipixDigit&);
  const AllPixMedipixDigit& operator=(const AllPixMedipixDigit&);
  int operator==(const AllPixMedipixDigit&) const;
...
typedef G4TDigiCollection<AllPixMedipixDigit> AllPixMedipixDigitsCollection;

extern G4Allocator<AllPixMedipixDigit> AllPixMedipixDigitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

inline void* AllPixMedipixDigit::operator new(size_t)
{
  void* aDigi;
  aDigi = (void*) AllPixMedipixDigitAllocator.MallocSingle();
  return aDigi;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

inline void AllPixMedipixDigit::operator delete(void* aDigi)
{
  AllPixMedipixDigitAllocator.FreeSingle((AllPixMedipixDigit*) aDigi);
}
